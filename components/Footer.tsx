      ...
      <article className="w-[1244px] m-auto">
        ...
        <div className="flex border-b">
          ...
          <div className="flex-1 mt-10">
            <h4 className="text-xl font-bold text-yellow-600">Navigation</h4>
            <ul>
              {footer.map((item) => (
          ...
          <div className="flex-1 mt-10">
            <h4 className="text-xl font-bold text-yellow-600">Contact</h4>
            <ul>
          ...
          <div className="flex-1 mt-10">
            ...
            <div className="flex items-center w-full mt-10">
              ...
              <button className=" w-12 h-10 flex items-center justify-center bg-yellow-600 text-white rounded-tr-xl rounded-br-xl">
                <Image
